...
public class MobCapturer extends JavaPlugin implements SlimefunAddon {
	...
	public void onEnable() {
		...
		register("Squid", EntityType.SQUID, new StandardMobAdapter<>(), "449088861fc1e14b605a5154d79fa7dd65e041a5c635d24744b3e152535");
		...
		register("Turtle", EntityType.TURTLE, new AnimalsAdapter<>(), "15a45e24cadc18f305291af45a22fc8b3607a675baa31ed583d3a56b15223c5c");
		register("Polar Bear", EntityType.POLAR_BEAR, new AnimalsAdapter<>(), "291abcab7a20b28195c0f1786db28c7670c2979243de71703b04e9d93f59aa8d");
		register("Dolphin", EntityType.DOLPHIN, new StandardMobAdapter<>(), "2480cd9577e2173e1c9de5e41318bd859696215a0a7de9242f01c01b8e6c06bf");
		
		register("Slime", EntityType.SLIME, new SlimeAdapter<>(), "9330af17f8512ed3b49e78bca7ef2d83f2dc1e598a8cb542ecc3b6becee9f57");
		register("Spider", EntityType.SPIDER, new StandardMobAdapter<>(), "5d59aa78cb7e9b6ca6fee4121329059dd68afddc0c8b53a906b7953994e8a76");
		register("Cave Spider", EntityType.CAVE_SPIDER, new StandardMobAdapter<>(), "16617131250e578333a441fdf4a5b8c62163640a9d06cd67db89031d03accf6");
		register("Guardian", EntityType.GUARDIAN, new StandardMobAdapter<>(), "fe119aaa4999648a75b978efafa97edab1cdca1ff1d8301ba61cdc2db1606e22");
		register("Elder Guardian", EntityType.ELDER_GUARDIAN, new StandardMobAdapter<>(), "9a839d8256c81cf1db8da8ff3f7b80cce2f865b80c9f66aea5340e697ea3e219");
		...
		register("Ghast", EntityType.GHAST, new StandardMobAdapter<>(), "c442c228f099fdfc1c6b46dfc80b252d81f7fb1739deb16ee7a597c17f7c9");
		register("Silverfish", EntityType.SILVERFISH, new StandardMobAdapter<>(), "d06310a8952b265c6e6bed4348239ddea8e5482c8c68be6fff981ba8056bf2e");
